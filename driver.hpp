...
void
verificationTest(char* resultFile, short scores[4], short* top_scores, short* ref_beg, short* ref_end, short* query_beg, short* query_end, char* CIGAR, int maxCIGAR);

int
scoreCIGAR(std::string CIGAR, short scores[4]);
